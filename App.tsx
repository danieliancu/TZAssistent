...
function App() {
  ...
  const handleSendMessage = async (textOverride?: string) => {
    ...
    try {
      ...
      // Only send the last 6 messages to the AI.
      const historyContext = newMessages.slice(-6);
  ...
  return (
    <div className="flex justify-center h-screen w-full bg-[#d1d7db] relative">
       ...
       <div className="w-full max-w-[800px] h-full bg-[#efeae2] relative flex flex-col shadow-xl chat-bg overflow-hidden">
          ...
          <div className="bg-[#f0f2f5] p-2 md:p-3 flex items-center gap-2 md:gap-4 shrink-0 z-20">
            ...
            {(inputValue.trim() && !isListening) ? (
               ...
               >
                 <svg className="w-5 h-5 md:w-6 md:h-6 transform rotate-90" fill="currentColor" viewBox="0 0 24 24"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"></path></svg>
               </button>
            ) : (
                <button 
